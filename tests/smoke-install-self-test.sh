...
"${repo_root}/tests/clipboard-monitoring-smoke.sh"
"${repo_root}/tests/clipboard-selection-composition-smoke.sh"
"${repo_root}/tests/clipboard-paper-import-smoke.sh"
"${repo_root}/tests/clipboard-color-smoke.sh"
"${repo_root}/tests/clipboard-formatted-text-smoke.sh"
"${repo_root}/tests/action-instruction-prompt-smoke.sh"
"${repo_root}/tests/add-to-calendar-prompt-smoke.sh"
"${repo_root}/tests/add-to-calendar-table-prompt-smoke.sh"
"${repo_root}/tests/add-to-calendar-multiple-dates-smoke.sh"
"${repo_root}/tests/add-to-calendar-mixed-events-smoke.sh"
"${repo_root}/tests/calendar-preview-apply-smoke.sh"
"${repo_root}/tests/calendar-queue-smoke.sh"
"${repo_root}/tests/calendar-queue-direct-smoke.sh"
