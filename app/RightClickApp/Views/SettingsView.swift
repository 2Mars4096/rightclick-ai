        ...
        ScrollView {
            Form {
                ...
                Section("Clipboard") {
                    ...
                    Text("Clipboard history stays local to this Mac. Known password-manager sources are excluded by default, and you can pause capture at any time from the menu bar or the hotkey window.")
                        .foregroundStyle(.secondary)
                }
